...
const Login: React.FC = () => {
  ...
  const handleDemoLogin = async () => {
    try {
      await login("demo@smarteats.com", "demo123");
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors duration-200"
            >
